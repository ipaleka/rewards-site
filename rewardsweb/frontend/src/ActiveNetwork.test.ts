...
describe("ActiveNetwork", () => {
  ...
  describe("bind", () => {
    ...
    it("should call setActiveNetwork with the correct network on button click", () => {
      activeNetwork.bind(element);
      const testnetButton = element.querySelector<HTMLButtonElement>(
    ...
    it("should handle multiple clicks correctly", () => {
      ...
      const mainnetButton = element.querySelector<HTMLButtonElement>(
    ...
    it("should make a fetch call to update the active network on the backend", async () => {
      ...
      jest
        .spyOn(activeNetwork as any, "getCsrfToken")
  ...
  describe("render", () => {
    ...
    beforeEach(() => {
      ...
      <button data-network="testnet">Testnet</button>
      <button data-network="mainnet">Mainnet</button>
      <span id="network-name"></span>  <!-- Add id here -->
    `;
      document.body.appendChild(element);
      networkSpan = element.querySelector("#network-name")!; // Select by ID
      testnetButton = element.querySelector<HTMLButtonElement>(
        '[data-network="testnet"]'
      )!;
      mainnetButton = element.querySelector<HTMLButtonElement>(
        '[data-network="mainnet"]'
      )!;
      activeNetwork.bind(element);
    });
